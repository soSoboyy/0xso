---
{"dg-publish":true,"permalink":"/0x/htb/cjca/bash/intro-bash/","created":"2026-05-14T19:07:15.688+01:00","dg-note-properties":{}}
---
...
history 
```
![Attachments/Pasted image 20260511181446.png](/img/user/0x/HTB/CJCA/Bash/Attachments/Pasted%20image%2020260511181446.png)
...
touch .file.txt
```
![Attachments/Pasted image 20260511181708.png](/img/user/0x/HTB/CJCA/Bash/Attachments/Pasted%20image%2020260511181708.png)
Completely hidden
...
ls -a
```
![Attachments/Pasted image 20260511182005.png](/img/user/0x/HTB/CJCA/Bash/Attachments/Pasted%20image%2020260511182005.png)
...
![Attachments/Pasted image 20260514172102.png](/img/user/0x/HTB/CJCA/Bash/Attachments/Pasted%20image%2020260514172102.png)
...
```
found this:
![Attachments/Pasted image 20260514172330.png](/img/user/0x/HTB/CJCA/Bash/Attachments/Pasted%20image%2020260514172330.png)
...
```
![Attachments/Pasted image 20260514172532.png](/img/user/0x/HTB/CJCA/Bash/Attachments/Pasted%20image%2020260514172532.png)
...
grep 'er
which gives:
![Attachments/Pasted image 20260514175751.png](/img/user/0x/HTB/CJCA/Bash/Attachments/Pasted%20image%2020260514175751.png)
