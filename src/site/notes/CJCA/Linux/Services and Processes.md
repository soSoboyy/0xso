---
{"dg-publish":true,"permalink":"/cjca/linux/services-and-processes/","created":"2026-04-12T14:11:19.509+01:00","dg-note-properties":{}}
---
...
- Semicolon (`;`) 
	- The semicolon (`;`) is a command separator and executes the commands by ignoring previous commands' results and errors.
	 ![Attachments/Pasted image 20260412132510.png](/img/user/CJCA/Linux/Attachments/Pasted%20image%2020260412132510.png)
...
- Double `ampersand` characters (`&&`)
	...
	![Attachments/Pasted image 20260412132605.png](/img/user/CJCA/Linux/Attachments/Pasted%20image%2020260412132605.png)
