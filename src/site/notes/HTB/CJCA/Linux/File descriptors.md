---
{"dg-publish":true,"permalink":"/htb/cjca/linux/file-descriptors/","dg-note-properties":{}}
---
...
```
![Attachments/Pasted image 20260409055207.png](/img/user/HTB/CJCA/Linux/Attachments/Pasted%20image%2020260409055207.png)
Green : STDOUT
Red : STDERR
...
```
![Attachments/Pasted image 20260409055533.png](/img/user/HTB/CJCA/Linux/Attachments/Pasted%20image%2020260409055533.png)
...
![Attachments/Pasted image 20260410051530.png](/img/user/HTB/CJCA/Linux/Attachments/Pasted%20image%2020260410051530.png)
...
![Attachments/Pasted image 20260412082421.png](/img/user/HTB/CJCA/Linux/Attachments/Pasted%20image%2020260412082421.png)
Here `-f7` shows the last element marked by the delimiter.

##### tr
Another way to do this is `tr`
![Attachments/Pasted image 20260412082628.png](/img/user/HTB/CJCA/Linux/Attachments/Pasted%20image%2020260412082628.png)
...
![Attachments/Pasted image 20260412083316.png](/img/user/HTB/CJCA/Linux/Attachments/Pasted%20image%2020260412083316.png)

### AWK
`awk` programming is beneficial, which allows us to display the first (`$1`) and last (`$NF`) result of the line.
![Attachments/Pasted image 20260412084040.png](/img/user/HTB/CJCA/Linux/Attachments/Pasted%20image%2020260412084040.png)
...
![Attachments/Pasted image 20260412084438.png](/img/user/HTB/CJCA/Linux/Attachments/Pasted%20image%2020260412084438.png)
