---
{"dg-publish":true,"permalink":"/htb/cjca/linux/services-and-processes/","dg-note-properties":{}}
---
...
- Semicolon (`;`) 
	- The semicolon (`;`) is a command separator and executes the commands by ignoring previous commands' results and errors.
	 ![Attachments/Pasted image 20260412132510.png](/img/user/HTB/CJCA/Linux/Attachments/Pasted%20image%2020260412132510.png)
...
- Double `ampersand` characters (`&&`)
	...
	![Attachments/Pasted image 20260412132605.png](/img/user/HTB/CJCA/Linux/Attachments/Pasted%20image%2020260412132605.png)
